        ...
        {"parts": [
            ...
            ("rows", [
                ...
                ("Players", "Beatgrid-native clips",
                 """Quantized bar launch, warp and vari-speed sync to the master tempo, flexible grid with key-lock, eight hot cues and cue preview from the browser. Waveform lanes show phase and sync against the beat grid, and an arrange view runs a master playhead over the whole set."""),
